...
class Test_loginpage():
      ...
      def test_login(self):
          ...
          sheets.selectsheet("test1completeflow")
          ...
          for category in range(1, len_of):
              ...
              if cat_name in a_list:
                      ...
                      for level in range(1, level_count):
                          ...
                          if levelcount in b_list:
                              ...
                              for question in range(1, que_count + 1):
                                ...
                                sheets.writedata(levels, 5, readfirstchoicetext)
                  ...
                  #excelutilities.writeData(path,excelsheet,category,column_value,cat_name)
                  #time.sleep(5)
